...
# COMENTÁRIO: Eu não sei se é para criar variáveis isoladas ou data frames com as variáveis indicadas. Farei os dois

# Criando variáveis isoladas
...
# Criando data frames com as variáveis
